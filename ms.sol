...
uint256 ethWei = 1 ether;
 ...
 uint256[30] affRate = [30,20,10,8,5,5,5,5,5,5,3,3,3,3,3,1,1,1,1,1,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5];
...
public
{
    levelReward_[1] = levelReward(5,1);
    levelReward_[2] = levelReward(10,10);
    levelReward_[3] = levelReward(30,20);
    levelReward_[4] = levelReward(50,30);
